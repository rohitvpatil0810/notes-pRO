    ...
    <div className="bg-white w-full  lg:w-56 lg:h-screen">
      <div className="content flex-col py-4 lg:py-8">
        <div className="flex px-4 justify-between items-center lg:block">
          ...
          <span onClick={handleExpand} className={`material-icons lg:hidden `}>
            menu
          </span>
        </div>
        <div className={`px-10 py-4 ${Menu} lg:block`}>
          <ul className="py-4 text-roboto text-base font-semibold flex flex-col ">
            <Link to="/dashboard">
              <li className="py-4 flex justify-end items-center">
                ...
                <span className="material-icons px-2 text-gray-700">
                  &#xe88a;
                </span>
              </li>
            </Link>
          ...
          <div
            onClick={logout}
            className="text-center w-fit mx-44 lg:mt-80 lg:mx-10 px-2 py-2 bg-faintBlue font-roboto text-head rounded-full cursor-pointer"
          >
            <div className="flex items-center">
              <span className="material-icons px-1">logout</span>Logout
            </div>
          </div>
        </div>
      </div>
