...
export default function UpdateNotes({setToast}) {
    ...
    return (
        <div>
            ...
            <Header></Header>
            <div className="text-lg lg:text-2xl text-head font-roboto font-semibold px-2">Update Your Note</div>
            <div className='block lg:flex'>
                <div className="bg-white font-bold my-3 lg:my-6 rounded-xl lg:w-5/12 lg:mr-auto">
                    <form onSubmit={updatenote} className='flex flex-col px-3 lg:px-10 py-4 text-base lg:text-lg'>
                        <label htmlFor="title" className='py-0 font-roboto my-1'>Title</label>
                        ...
                        <label htmlFor="desc" className='py-0 font-roboto my-1'>Description</label>
