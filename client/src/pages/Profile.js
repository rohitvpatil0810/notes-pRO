        ...
        <div className='px-5 lg:px-12 font-roboto flex flex-col'>
            ...
            <div>
                <div className='px-2 flex-col'>
                    ...
                    <div className='text-2xl lg:text-4xl font-head font-semibold'>{Username}</div>
                </div>
                <div className='py-3 lg:py-4'>
                    <div className='text-lg lg:text-2xl text-head font-roboto font-semibold px-2'>Profile</div>
                </div>
            </div>
            <div className='block lg:flex'>
                <div className="bg-white lg:ml-2 rounded-xl px-3 py-2 ">
                    <div className="w-20 h-20 pt-6 pb-20 mx-auto"><img src={user} alt="" className=''/></div>
                    ...
                    <div className="block lg:flex">
                    <Link to='/notes'><button className='text-head bg-faintBlue rounded-full font-roboto text-sm lg:text-base px-2 py-2 flex items-center  my-3 mx-4'><span className="material-icons pr-2">sticky_note_2</span>Your Notes</button></Link>
                    <Link to='/createnotes'><button className='text-head bg-faintBlue rounded-full font-roboto text-sm lg:text-base px-2 py-2 flex items-center  my-3 mx-4'><span className="material-icons pr-2">add_circle_outline</span>Create New Note</button></Link>
                    </div>
                </div>
                <div className="bg-white my-4 px-4 lg:w-96 lg:ml-40 rounded-xl lg:px-8 py-2">
                    <div className='text-2xl font-head font-semibold py-4 mx-auto'>About Notes pRO</div>
